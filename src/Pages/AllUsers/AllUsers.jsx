...
const AllUsers = () => {
    ...
    const handleMakeAdmin = (user) => {
        fetch(`https://tech-programmer-bd-server.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH',
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleMakeInstructor = (user) => {
        fetch(`https://tech-programmer-bd-server.vercel.app/users/instructor/${user._id}`, {
            method: 'PATCH',
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleDeleteUser = (user) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://tech-programmer-bd-server.vercel.app/users/${user._id}`, {
                    method: 'DELETE',
                })
                    .then(res => res.json())
                    .then(data => {
