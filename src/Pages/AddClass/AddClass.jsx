        ...
        fetch(img_hosting_url, {
            ...
            .then(imgResponse => {
                if (imgResponse.success) {
                    console.log('inside on img_hosting fetch');
                    ...
                    fetch('http://localhost:5000/classes', {
                        ...
                        .then(res => res.json())
                        .then(data => {
                            console.log('inside on backend fetch');
                            if (data.insertedId) {
                                form.reset();
                                Swal.fire({
    ...
    return (
        <div className="bg-gray-200">
            <div className='sm:w-11/12 md:w-9/12 my-7 mx-auto'>
                <form onSubmit={handleSubmit(onSubmitClass)} className="space-y-12">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <input className="cursor-pointer rounded-md bg-[#9833f9] px-3 py-2 text-md font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" type="submit" value="Add Class" />
                    </div>
                </form>
            </div>
        </div>
